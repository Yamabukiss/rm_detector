#include "../include/rm_detector/detector2.h"
#include "../include/rm_detector/logging.h"
...
namespace rm_detector {
    void Detector::onInit() {
        ...
        generate_grids_and_stride(INPUT_W, INPUT_H);  // the wide height strides need to be changed depending on demand
...
#pragma omp section
    ...
    static void
    generate_yolox_proposals(std::vector<GridAndStride> grid_strides, float *feat_blob, float prob_threshold,
    ...
    static void
    decode_outputs(float *prob, std::vector<Object> &objects, float scale, const int img_w, const int img_h) {
...
//                    cv::FONT_HERSHEY_SIMPLEX, 0.4, txt_color, 1);
        ...
        cv::imwrite("/home/dynamicx/catkin_ws/src/rm_detector/det_res.jpg", image);
...
//        const std::string engine_file_path {argv[1]};
        std::string engine_file_path = "/home/dynamicx/catkin_ws/src/rm_detector/engine1.engine";
